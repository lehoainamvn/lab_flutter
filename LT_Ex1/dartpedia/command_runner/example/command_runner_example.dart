...
class PrettyEcho extends Command {
  ...
  FutureOr<String> run(ArgResults arg) {
    ...
    // Lặp qua từng từ và đổi màu luân phiên: Xanh -> Vàng -> Đỏ
    for (var i = 0; i < words.length; i++) {
      var word = words[i];
      switch (i % 3) {
        case 0:
          prettyWords.add(word.titleText); // Dùng extension
        case 1:
          prettyWords.add(word.instructionText); // Dùng extension
        case 2:
          prettyWords.add(word.errorText); // Dùng extension
      }
    }
