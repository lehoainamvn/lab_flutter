    ...
    if (content.trim().isNotEmpty) {
      ...
      if (listScrollController.hasClients) {
        listScrollController.animateTo(
          listScrollController.position.maxScrollExtent + 100, // Scroll to bottom
          ...
          children: <Widget>[
            messageChat.type == TypeMessage.text
                ...
                : messageChat.type == TypeMessage.image
                    ...
                    : Container(
                        child: Image.network(
                          'https://raw.githubusercontent.com/duytq94/flutter-chat-demo/master/images/${messageChat.content}.gif',
                          width: 100,
                          height: 100,
                          fit: BoxFit.cover,
                        ),
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                if (snapshot.hasData) {
                  ...
                  if (listMessage.length > 0) {
                    ...
                    return const Center(child: Text("No message here..."));
                  }
                } else {
                  return const Center(
                    child: CircularProgressIndicator(
